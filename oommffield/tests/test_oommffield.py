...
class TestOOMMFField(object):
    ...
    def create_scalar_fs(self):
        ...
        for i in range(len(cmin_list)):
            f = OOMMFField(cmin_list[i], cmax_list[i], d_list[i], dim=1)
            scalar_fs.append(f)
    ...
    def create_vector_fs(self):
        ...
        vector_fs = []
        for i in range(len(cmin_list)):
            f = OOMMFField(cmin_list[i], cmax_list[i], d_list[i], dim=3)
            vector_fs.append(f)
    ...
    def test_init(self):
        ...
        f = OOMMFField(cmin, cmax, d, dim=2, value=value, name=name)
    ...
    def test_init_wrong_cmin(self):
        ...
        with pytest.raises(TypeError):
            f = OOMMFField(cmin, cmax, d, dim=3, name=name)
    ...
    def test_init_wrong_dim(self):
        ...
        with pytest.raises(TypeError):
            f = OOMMFField(cmin, cmax, d, dim=3.5, name=name)
    ...
    def test_index2coord(self):
        ...
        f = OOMMFField(cmin, cmax, d, dim=2, name=name)
    ...
    def test_write_oommf_file(self):
        tol = 1e-12
